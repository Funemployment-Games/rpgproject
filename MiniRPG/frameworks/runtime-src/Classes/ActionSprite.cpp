...
void ActionSprite::walkNumTilesWithDirection(int numTilesToMove, ActionSpriteDirection directionToMove, bool forceMovement)
{
    ...
    {
        //printf("Move out X: %f, Y: %f\n", m_vDesiredPosition.x, m_vDesiredPosition.y);
        stopAllActions();
        // Animate the player
    ...
    {
        //printf("ActionSprite::walkNumTilesWithDirection !isValidDestination\n");
    }
    else if(m_actionState != kActionStateAutoWalkStart)
    {
        //printf("ActionSprite::walkNumTilesWithDirection m_actionState != kActionStateAutoWalkStart\n");
    }
}
